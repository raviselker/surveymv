...
surveyPlotOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "surveyPlotOptions",
...
surveyPlotResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "surveyPlotResults",
...
surveyPlotBase <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "surveyPlotBase",
